                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                                    {sectionNotes.map((note, index) => (
                                        <motion.div
                                            ...
                                            className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-all group overflow-hidden flex flex-col h-full"
                                        >
                                            <div className="p-6 flex flex-col h-full">
                                                <div className="flex items-start justify-between mb-4">
                                                    <div className="flex items-center justify-between gap-3">
                                                        <div className={`p-2.5 rounded-xl border transition-colors ${note.fileData ? 'bg-blue-50 dark:bg-blue-900/20 border-blue-100 dark:border-blue-900 text-blue-600 dark:text-blue-400' : 'bg-slate-900 dark:bg-slate-800 border-slate-800 dark:border-slate-700 text-white'}`}>
                                                            {note.fileData ? (
                                                    ...
                                                    <div className="flex items-center gap-1 opacity-100 sm:opacity-0 group-hover:opacity-100 transition-opacity">
                                                        <button
                                                            ...
                                                            className="p-1.5 rounded-lg hover:bg-red-50 dark:hover:bg-red-950/30 text-slate-400 hover:text-red-600 transition-colors"
                                                            title="Delete Note"
                                                        >
                                                ...
                                                <div className="flex flex-wrap justify-between items-center gap-3 mb-4 text-[11px] font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                                                    ...
                                                    {user?._id === note.user && (
                                                        (
                                                            note.isGlobal ? (
                                                                <button className="bg-blue-50 dark:bg-blue-950/20 border border-blue-600 dark:border-blue-500 hover:bg-blue-600 dark:hover:bg-blue-500 hover:text-white transition-colors text-blue-600 dark:text-blue-400 p-2 px-4 cursor-pointer rounded-md"
                                                    ...
                                                    {note.fileData ? (
                                                        ...
                                                        <div className="relative group/code mb-4">
                                                            ...
                                                            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 max-h-40 overflow-hidden relative">
                                                                ...
                                                                <div className="absolute inset-x-0 bottom-0 h-12 bg-linear-to-t from-slate-50 dark:from-slate-950 to-transparent" />
                                                            </div>
                                                        </div>
                                                    )}
                                                </div>
