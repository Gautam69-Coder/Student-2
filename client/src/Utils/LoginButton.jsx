...
const Button = ({ text,size }) => {
  return (
    <button className="relative inline-flex w-full items-center justify-center px-8 py-2.5 overflow-hidden tracking-tighter text-white bg-gray-800 rounded-md group">
      ...
      <span className={`relative text-${size || "base"} font-semibold`}>{text}</span>
    </button>
  );
}
