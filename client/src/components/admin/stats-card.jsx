...
export function StatsCard({ title, value, change, icon: Icon, color }) {
    return (
        <motion.div
            ...
            className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-[#E5E5E5] dark:border-slate-800 transition-all duration-300 hover:border-slate-300 dark:hover:border-slate-700"
        >
