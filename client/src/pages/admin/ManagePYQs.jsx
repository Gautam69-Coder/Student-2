...
export function ManagePYQs() {
    ...
    return (
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
            ...
            <motion.div variants={itemVariants} className="bg-white dark:bg-slate-900 rounded-[10px] p-8 border border-[#E5E5E5] dark:border-slate-800 shadow-sm max-w-2xl">
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="mt-2 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-[10px] p-10 text-center hover:border-slate-400 dark:hover:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all cursor-pointer">
                    ...
                    <button className="w-full bg-slate-900 dark:bg-slate-100 hover:bg-slate-800 dark:hover:bg-white text-white dark:text-slate-900 font-medium rounded-[10px] h-12 flex items-center justify-center gap-2 transition-all active:scale-[0.99]">
