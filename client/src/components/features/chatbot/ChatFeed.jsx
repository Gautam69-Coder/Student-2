                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="text-sm font-bold text-slate-900 flex items-center gap-2">
                            ...
                            <Badge
                                variant="outline"
                                className="bg-lime-500/10 text-lime-600 text-[10px] font-bold border-lime-500/20 uppercase tracking-widest px-1.5 py-0.5"
                            >
                                {systemPrompt}
                            </Badge>
                        </div>
                            ...
                            {isLoadingResponse && (
                                ...
                                >
                                    ...
                                    <div className="bg-white border border-slate-200 text-slate-400 px-4 py-3 rounded-2xl rounded-tl-none text-xs flex items-center gap-2">
                                        ...
                                        <span className="ml-1 font-semibold text-lime-600/80">
            ...
            <div className="p-4 bg-white border-t border-slate-200">
                <div className="max-w-3xl mx-auto flex gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center w-12 h-12 rounded-xl font-bold bg-lime-500 text-black hover:bg-lime-400 disabled:opacity-50 disabled:hover:bg-lime-500 transition-all active:scale-95 shrink-0 cursor-pointer"
                    >
