        ...
        <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden transition-all duration-300 hover:shadow-md">
                ...
                <div className="bg-slate-50 dark:bg-slate-950/50 p-6 border-t border-slate-200 dark:border-slate-800">
                    <h3 className="text-sm font-semibold text-slate-900 dark:text-white mb-4 uppercase tracking-wider">Quick Select Categories</h3>
                        ...
                        {categories.map((cat) => (
                            <button
                                ...
                                className={`p-4 rounded-xl border flex flex-col items-center gap-2 transition-all ${formData.category === cat.name
                                    ? 'bg-white dark:bg-slate-800 border-slate-900 dark:border-slate-400 shadow-sm scale-105 text-slate-900 dark:text-white'
                                    : 'bg-transparent border-slate-200 dark:border-slate-800 hover:border-slate-400 dark:hover:border-slate-600 text-slate-500'
                                    }`}
                            >
                                <cat.icon className={`w-5 h-5 ${formData.category === cat.name ? 'text-slate-900 dark:text-white' : 'text-slate-400'}`} />
